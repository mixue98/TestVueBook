<template>
  <div id="bg">
      ...
      <el-form :model="ruleForm2" :rules="rules2" ref="ruleForm2"  label-position="left" label-width="0px" class="demo-ruleForm   login-container">
	    ...
	    <el-button type="" class="fel-btn"><router-link to='Regi'>立即去注册！</router-link></el-button><br>
	   </el-form>
    ...
    methods: {
      ...
      handleSubmit2(ev) {
        ...
        this.$refs.ruleForm2.validate((valid) => {
          if (valid) {
            _this.logining= true
            var loginParams = { cname: _this.ruleForm2.account, cpwd: _this.ruleForm2.checkPass }
...
.titleTop{
  ...
  #bg{
    ...
    padding: 0 0;
    height: 650px;
    background: url("../assets/bg/bg08.jpg") no-repeat center;
